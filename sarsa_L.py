...
# 2 - gamma
# 3 - alpha
def sarsa_L(para_set, env_name, iteration, episode_limit):
	e = para_set[1]
	...
	r_list = []
	for e_limit in xrange(episode_limit, episode_limit/data_points_count):
		total_reward = 0		
		for i in range(iteration):
			total_reward += sarsa_eligibility_trace(e_limit)
