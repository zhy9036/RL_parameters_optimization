...
def random_search(para_set, pos, ran):
	...
	for r in range(3):
		...
		while not local_opt:
			...
			reward, r_left, r_right = sarsa(para_copy), None, None
			if para_left:
	 			r_left = sarsa(para_copy)
			if para_right:
				r_right = sarsa(para_copy)
	...
	return g_p, g_r
print random_search([0.5,0.5,0.5,0.5], 0, (0.1, 0.9))
